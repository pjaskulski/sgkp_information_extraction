...
from model_struktura import EntryModel, StrukturaWyznaniowaModel
    ...
    if rodzaj == "zbiorcze":
        ...
        for i, element in enumerate(elements):
            ...
            try:
                ...
                if result.ludnosc_wyznanie and isinstance(result.ludnosc_wyznanie, list) and len(result.ludnosc_wyznanie) > 0:
                    try:
                        parsed_data = []
                        for item in result.ludnosc_wyznanie:
                            parsed_data_item = StrukturaWyznaniowaModel.model_dump(item)
                            for l in parsed_data_item["struktura_wyznaniowa"]:
                    ...
                    element["ludność_wyznanie"] = parsed_data
        ...
        try:
            ...
            if result.ludnosc_wyznanie and isinstance(result.ludnosc_wyznanie, list) and len(result.ludnosc_wyznanie) > 0:
                ...
                entry_data["ludność_wyznanie"] = parsed_data
